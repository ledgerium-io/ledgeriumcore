...
// issuing, receiving, verifying cheques in lgum; (auto)cashing cheques in lgum
// as well as (auto)depositing lgum to the chequebook contract.
package chequebook
...
// * depositing lgum to the chequebook
// * watching incoming lgum
