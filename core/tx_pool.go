...
func (pool *TxPool) validateTx(tx *types.Transaction, local bool) error {
	...
	//Ledgerium Blockchain expects the gasprice of the transaction a positive number
	...
	//Ledgerium Blockchain expects the gasprice of the transaction a positive number and pool gas price more than tx gasprice
	...
	// Xlg value should be positive even for private transactions, commenting this code
